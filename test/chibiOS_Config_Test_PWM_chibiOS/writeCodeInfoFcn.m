% Autogenerated file: Wed Dec 18 00:18:49 2013
...
tmpActualArgs = [tmpActualArgs; Const_TID0];
  ...
  OutputUpdate0_Prototype.HeaderFile = ['chibiOS_Config_Test_PWM', '.h'];
  OutputUpdate0_Prototype.SourceFile = ['chibiOS_Config_Test_PWM', '.c'];
  ...
  OutputUpdate0_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate0_Prototype.Name = 'chibiOS_Config_Test_PWM_step';
  time_0 = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, 0));
...
tmpActualArgs = [tmpActualArgs; Const_TID1];
  ...
  OutputUpdate1_Prototype.HeaderFile = ['chibiOS_Config_Test_PWM', '.h'];
  OutputUpdate1_Prototype.SourceFile = ['chibiOS_Config_Test_PWM', '.c'];
  ...
  OutputUpdate1_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate1_Prototype.Name = 'chibiOS_Config_Test_PWM_step';
...
tmpActualArgs = [tmpActualArgs; Const_TID2];
  ...
  OutputUpdate2_Prototype.HeaderFile = ['chibiOS_Config_Test_PWM', '.h'];
  OutputUpdate2_Prototype.SourceFile = ['chibiOS_Config_Test_PWM', '.c'];
  ...
  OutputUpdate2_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate2_Prototype.Name = 'chibiOS_Config_Test_PWM_step';
...
tmpActualArgs = [tmpActualArgs; Const_TID3];
  ...
  OutputUpdate3_Prototype.HeaderFile = ['chibiOS_Config_Test_PWM', '.h'];
  OutputUpdate3_Prototype.SourceFile = ['chibiOS_Config_Test_PWM', '.c'];
  ...
  OutputUpdate3_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate3_Prototype.Name = 'chibiOS_Config_Test_PWM_step';
...
tmpActualArgs = [tmpActualArgs; Const_TID4];
  ...
  OutputUpdate4_Prototype.HeaderFile = ['chibiOS_Config_Test_PWM', '.h'];
  OutputUpdate4_Prototype.SourceFile = ['chibiOS_Config_Test_PWM', '.c'];
  ...
  OutputUpdate4_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate4_Prototype.Name = 'chibiOS_Config_Test_PWM_step';
