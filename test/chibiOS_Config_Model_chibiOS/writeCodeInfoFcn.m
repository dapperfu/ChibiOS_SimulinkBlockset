% Autogenerated file: Sat Dec 14 23:07:14 2013
function writeCodeInfoFcn

% Load a ComponentInterface object from IR
codeIRInfoStruct = load('C:/Projects/ChibiOS_SimulinkBlockset/test/chibiOS_Config_Model_chibiOS/tlc/codeIRInfo.mat');
...
tmpActualReturn = [];
  ...
  Initialize_Prototype.HeaderFile = ['chibiOS_Config_Model', '.h'];
  Initialize_Prototype.SourceFile = ['chibiOS_Config_Model', '.c'];
  ...
  Initialize_Interface.ActualReturn = tmpActualReturn;
      ...
      Initialize_Prototype.Name = 'chibiOS_Config_Model_initialize';
...
tmpActualArgs = [tmpActualArgs; Const_TID0];
  ...
  OutputUpdate0_Prototype.HeaderFile = ['chibiOS_Config_Model', '.h'];
  OutputUpdate0_Prototype.SourceFile = ['chibiOS_Config_Model', '.c'];
  ...
  OutputUpdate0_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate0_Prototype.Name = 'chibiOS_Config_Model_step';
  time_0 = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, 0));
...
tmpActualArgs = [tmpActualArgs; Const_TID1];
  ...
  OutputUpdate1_Prototype.HeaderFile = ['chibiOS_Config_Model', '.h'];
  OutputUpdate1_Prototype.SourceFile = ['chibiOS_Config_Model', '.c'];
  ...
  OutputUpdate1_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate1_Prototype.Name = 'chibiOS_Config_Model_step';
...
tmpActualArgs = [tmpActualArgs; Const_TID2];
  ...
  OutputUpdate2_Prototype.HeaderFile = ['chibiOS_Config_Model', '.h'];
  OutputUpdate2_Prototype.SourceFile = ['chibiOS_Config_Model', '.c'];
  ...
  OutputUpdate2_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate2_Prototype.Name = 'chibiOS_Config_Model_step';
...
tmpActualArgs = [tmpActualArgs; Const_TID3];
  ...
  OutputUpdate3_Prototype.HeaderFile = ['chibiOS_Config_Model', '.h'];
  OutputUpdate3_Prototype.SourceFile = ['chibiOS_Config_Model', '.c'];
  ...
  OutputUpdate3_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate3_Prototype.Name = 'chibiOS_Config_Model_step';
...
Const_TID4 = RTW.DataInterface('', 'TID4', Lit_4, []);
...
tmpActualArgs = [tmpActualArgs; Const_TID4];
  ...
  OutputUpdate4_Prototype = RTW.CImplementation;
  OutputUpdate4_Prototype.Arguments  = tmpArgs;
  OutputUpdate4_Prototype.Return     = tmpRet;
  OutputUpdate4_Prototype.HeaderFile = ['chibiOS_Config_Model', '.h'];
  OutputUpdate4_Prototype.SourceFile = ['chibiOS_Config_Model', '.c'];
  ...
  OutputUpdate4_Interface.ActualReturn = tmpActualReturn;
      ...
      OutputUpdate4_Prototype.Name = 'chibiOS_Config_Model_step';
