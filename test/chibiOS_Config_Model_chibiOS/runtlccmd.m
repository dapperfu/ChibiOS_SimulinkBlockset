function runtlccmd
% RUNTLCCMD - run tlc command (regenerate C code from .rtw file) for model chibiOS_Config_Model
% This function will run the tlc command stored in the variable 
% "tlccmd" in tlccmd.mat, whose contents is as follows:
% 
% 	tlc
% 	-r
% 	C:\Projects\ChibiOS_SimulinkBlockset\test\chibiOS_Config_Model_chibiOS\chibiOS_Config_Model.rtw
% 	C:\Projects\ChibiOS_SimulinkBlockset\rtw\ChibiOS.tlc
% 	-OC:\Projects\ChibiOS_SimulinkBlockset\test\chibiOS_Config_Model_chibiOS
% 	-IC:\Projects\ChibiOS_SimulinkBlockset\rtw
% 	-IC:\Projects\ChibiOS_SimulinkBlockset\blocks
% 	-IC:\Projects\ChibiOS_SimulinkBlockset\test\chibiOS_Config_Model_chibiOS\tlc
...
% 	-p10000
   ...
   if ~sysopen
      ...
      rtwprivate('rtwattic', 'setBuildDir', 'C:\Projects\ChibiOS_SimulinkBlockset\test\chibiOS_Config_Model_chibiOS');
      rtwprivate('ec_set_replacement_flag', 'chibiOS_Config_Model');
      load tlccmd.mat;
      savedpwd = pwd;
      cd ..;
