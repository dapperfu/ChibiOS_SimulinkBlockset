...
if ischar(block.DialogPrm(1).Data)
	block.WriteRTWParam('string','CH_FREQUENCY', block.DialogPrm(1).Data);
else
	block.WriteRTWParam('string','CH_FREQUENCY', num2str(block.DialogPrm(1).Data));
end
% Round robin interval
if ischar(block.DialogPrm(2).Data)
	block.WriteRTWParam('string','CH_TIME_QUANTUM', block.DialogPrm(2).Data);
else
	block.WriteRTWParam('string','CH_TIME_QUANTUM', num2str(block.DialogPrm(2).Data));
end
% Managed RAM size
if ischar(block.DialogPrm(3).Data)
	block.WriteRTWParam('string','CH_MEMCORE_SIZE', block.DialogPrm(3).Data);
else
	block.WriteRTWParam('string','CH_MEMCORE_SIZE', num2str(block.DialogPrm(3).Data));
end
